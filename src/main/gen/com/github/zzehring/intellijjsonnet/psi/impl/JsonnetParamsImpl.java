...
public class JsonnetParamsImpl extends ASTWrapperPsiElement implements JsonnetParams {

  public JsonnetParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JsonnetParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JsonnetParam.class);
  }
