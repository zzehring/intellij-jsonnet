...
class JLSSettingsComponent {
    ...
    private val enableTankaMode = JBCheckBox("Enable Tanka mode (auto-detect jpath from vendor/lib directories)")
    ...
    init {
        this.settingsPanel = FormBuilder.createFormBuilder()
            ...
            .addTooltip("Enable Tanka mode to auto-detect jpaths from vendor/ and lib/ directories. Disable if using custom jpaths. IDE restart required.")
            .panel
